    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnIngresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RestApi.correo = txtcorreo.getText().toString();
...
//========CREDENCIALES PUBLICAS PARA LLAMAR EN LAS ACTIVIDADES Y EVITAR QUE LA INFORMACION SE PIERDA====///
    ...
    private void loginUsuario(String correo, String clave) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, RestApi.EndPointValidarLogin,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < mensajeArray.length(); i++) {
                        ...
                        codigo = RowMensaje.getString("id_usuario");
                        RestApi.correo = txtcorreo.getText().toString();
                        RestApi.id_usuario = codigo;
                    }
